const Footer = () => {
  return (
    <footer className="footer text-base-content p-10 bg-black dark:bg-secondary">
      <aside>
        <svg
          width="50"
          height="50"
        ...
        <p>
          Furniflex Inc.
          <br />
          Stylish Solutions for Modern Living
        </p>
      </aside>
      <nav>
        <h6 className="footer-title">Our Services</h6>
        <a className="link link-hover">Custom Furniture</a>
